...
const AllUsers = () => {
  ...
  return (
   ...
   {allUsers.map((user, idx) => <tr className="bg-white border-b transition duration-300 ease-in-out hover:bg-slate-50 border-b-slate-200" key={user._id}>
    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{idx + 1}</td>
    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">{user._id.slice(-6)}</td>
